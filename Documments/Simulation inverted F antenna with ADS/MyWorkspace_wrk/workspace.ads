<ADSWorkspace Revision="5" Version="100">
    <Workspace Name="">
        ...
        <Cell Name="MyLibrary_lib:Version1" />
        <Log Name="readegs.log" />
        <Dataset Name="Version1_MomUW.ds" />
        <Data_Files Name="Version1_MomUW.ds" />
        <ConfigFile Name="dds.cfg" />
        <Data_Display Name="Version1.dds" />
        <Dataset Name="Version1_MomUW_a.ds" />
        <Data_Files Name="Version1_MomUW_a.ds" />
        <Log Name="search_history.log" />
        <Log Name="netlist.log" />
        <Dataset Name="Version1_emSetup.ds" />
        <Data_Files Name="Version1_emSetup.ds" />
        <Dataset Name="Version1_emSetup_a.ds" />
        <Data_Files Name="Version1_emSetup_a.ds" />
        <Dataset Name="Version1.ds" />
        <Data_Files Name="Version1.ds" />
        <Data_Files Name="Version1_data\logFile.txt" />
    </Workspace>
</ADSWorkspace>
